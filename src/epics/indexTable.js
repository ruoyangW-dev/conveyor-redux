...
export const generateIndexTableFilterChangeEpic = (schema, doRequest) => action$ => action$.pipe(
...
export const generateIndexTableSortChangeEpic = (schema, doRequest) => action$ => action$.pipe(
