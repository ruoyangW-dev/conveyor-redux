...
var initState = {
  amtPerPage: DEFAULT_PAGINATION_AMT
};
      ...
      case Actions.INDEX_CLEAR_FILTERS:
        {
          ...
          return R.assocPath([_modelName2, 'page', 'currentPage'], 0, removeAll(_modelName2));
        }
      ...
      case Actions.INDEX_TABLE_FILTER_SUBMIT:
        {
          ...
          return R.pipe(R.assocPath([_modelName6, 'filter', 'filtersAreActive'], filtersAreActive), R.assocPath([_modelName6, 'page', 'currentPage'], 0))(state);
        }
      ...
      case Actions.INDEX_TABLE_SORT_CHANGE:
        {
          ...
          return R.pipe(R.assocPath([_modelName7, 'sort'], {
            fieldName: _fieldName4,
            sortKey: sortKey
          }), R.assocPath([_modelName7, 'page', 'currentPage'], 0))(state);
        }
      ...
      case Actions.UPDATE_MODEL_INDEX:
        {
          ...
          var amtPerPage = R.prop('amtPerPage', state) || DEFAULT_PAGINATION_AMT;
          var lastIndex = null;
          ...
          return R.pipe(R.assocPath([_modelName11, 'page', 'lastIndex'], lastIndex), R.assocPath([_modelName11, 'page', 'total'], data.length))(state);
        }
      ...
      case Actions.UPDATE_MODEL_DETAIL:
        {
          ...
          var _amtPerPage = R.prop('amtPerPage', state) || DEFAULT_PAGINATION_AMT;
          ...
          if (newNode) {
            for (var _i = 0, _Object$entries2 = _Object$entries(newNode); _i < _Object$entries2.length; _i++) {
              ...
              if (type && _includesInstanceProperty(type).call(type, 'ToMany') && !R.isEmpty(obj)) {
                ...
                var lastIndexRel = Math.floor((_totalDataLength - 1) / _amtPerPage);

                if (lastIndexRel > 0) {
                  state = R.pipe(R.assocPath([_modelName12, 'fields', _fieldName7, 'page', 'lastIndex'], lastIndexRel), R.assocPath([_modelName12, 'fields', _fieldName7, 'page', 'total'], _totalDataLength))(state);
                }
              }
            }
          }
