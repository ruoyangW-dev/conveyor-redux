      ...
      case Actions.INDEX_CLEAR_FILTERS:
        {
          ...
          return R.assocPath(['page', _modelName], 0, removeAll(_modelName));
        }
      ...
      case Actions.INDEX_TABLE_FILTER_SUBMIT:
        {
          ...
          return R.pipe(R.assocPath(['filtersAreActive', _modelName5], filtersAreActive), R.assocPath(['page', _modelName5], 0))(state);
        }
      ...
      case Actions.INDEX_TABLE_SORT_CHANGE:
        {
          ...
          return R.pipe(R.assocPath(['sort', _modelName7], {
            fieldName: _fieldName4,
            sortKey: sortKey
          }), R.assocPath(['page', _modelName7], 0))(state);
        }
...
export var selectPaginatedTableView = function selectPaginatedTableView(state, modelName) {
  ...
  return R.assocPath(['lastIndexPagination', modelName], lastIndex, selectTableView(state));
};