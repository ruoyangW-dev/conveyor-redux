...
export var hideTableChange = actionDisp(Actions.HIDE_TABLE_CHANGE); // epics
...
export var changePage = actionDisp(Actions.CHANGE_PAGE); // model

export var updateModelDetail = actionDisp(Actions.UPDATE_MODEL_DETAIL);
export var updateModelIndex = actionDisp(Actions.UPDATE_MODEL_INDEX); // logger

export var errorLogger = actionDisp(Actions.ERROR_LOGGER);