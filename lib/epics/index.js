...
import { generateFetchModelIndexEpic, generateFetchModelDetailEpic, generateRequestDeleteModelEpic, generateRequestDeleteModelFromDetailPageEpic, generateRequestDeleteRelTableModelEpic } from './model';
...
import { generateDetailAttributeEditSubmitEpic, generateDetailTableEditSubmitEpic, generateDetailTableRemoveSubmitEpic, generateIndexEditSubmitEpic, generateInlineFileDeleteEpic } from './edit';
import { generateDetailAttributeEditSubmitCheckEpic, generateDetailTableEditSubmitCheckEpic, generateIndexEditSubmitCheckEpic, generateSaveCreateCheckEpic } from './validation';
...
export var generateConveyorEpics = function generateConveyorEpics(schema, doRequest) {
  ...
  var detailAttributeEditSubmitEpic = generateDetailAttributeEditSubmitEpic(schema, doRequest);
  var detailTableEditSubmitEpic = generateDetailTableEditSubmitEpic(schema, doRequest);
  var detailTableRemoveSubmitEpic = generateDetailTableRemoveSubmitEpic(schema, doRequest);
  var indexEditSubmitEpic = generateIndexEditSubmitEpic(schema, doRequest);
  var inlineFileDeleteEpic = generateInlineFileDeleteEpic(schema, doRequest);
  var saveCreateEpic = generateSaveCreateEpic(schema, doRequest);
  var requestDeleteModelEpic = generateRequestDeleteModelEpic(schema, doRequest);
  var requestDeleteModelFromDetailPageEpic = generateRequestDeleteModelFromDetailPageEpic(schema, doRequest);
  var requestDeleteRelTableModelEpic = generateRequestDeleteRelTableModelEpic(schema, doRequest);
  var detailAttributeEditSubmitCheckEpic = generateDetailAttributeEditSubmitCheckEpic(schema);
  var detailTableEditSubmitCheckEpic = generateDetailTableEditSubmitCheckEpic(schema);
  var indexEditSubmitCheckEpic = generateIndexEditSubmitCheckEpic(schema);
  var saveCreateCheckEpic = generateSaveCreateCheckEpic(schema);
  var fetchDeleteDetailEpic = generateFetchDeleteDetailEpic(doRequest);
  return {
    ...
    detailAttributeEditSubmitEpic: detailAttributeEditSubmitEpic,
    detailTableEditSubmitEpic: detailTableEditSubmitEpic,
    detailTableRemoveSubmitEpic: detailTableRemoveSubmitEpic,
    indexEditSubmitEpic: indexEditSubmitEpic,
    inlineFileDeleteEpic: inlineFileDeleteEpic,
    saveCreateEpic: saveCreateEpic,
    requestDeleteModelEpic: requestDeleteModelEpic,
    requestDeleteModelFromDetailPageEpic: requestDeleteModelFromDetailPageEpic,
    requestDeleteRelTableModelEpic: requestDeleteRelTableModelEpic,
    detailAttributeEditSubmitCheckEpic: detailAttributeEditSubmitCheckEpic,
    detailTableEditSubmitCheckEpic: detailTableEditSubmitCheckEpic,
    indexEditSubmitCheckEpic: indexEditSubmitCheckEpic,
    saveCreateCheckEpic: saveCreateCheckEpic,
    fetchDeleteDetailEpic: fetchDeleteDetailEpic
  };
};
/**
