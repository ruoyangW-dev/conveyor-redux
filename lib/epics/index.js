...
import { generateFetchSearchEntriesEpic, generateSearchQueryTextChangedEpic } from './search';
import { generateIndexTableFilterChangeEpic, generateIndexTableSortChangeEpic } from './tableView';
...
export var generateConveyorEpics = function generateConveyorEpics(schema, doRequest) {
  ...
  var searchQueryTextChangedEpic = generateSearchQueryTextChangedEpic(schema, doRequest);
  ...
  return {
    ...
    routeEpic: routeEpic,
    searchQueryTextChangedEpic: searchQueryTextChangedEpic,
