...
export var generateIndexTableFilterChangeEpic = function generateIndexTableFilterChangeEpic(schema, doRequest) {
...
export var generateIndexTableSortChangeEpic = function generateIndexTableSortChangeEpic(schema, doRequest) {
  return function (action$) {
